...
$q = "UPDATE projects SET 
                    ...
                    card_image_title=:card_image_title,
                    card_image_description=:card_image_description,
                    card_image_icon=:card_image_icon,
                    card_image_color=:card_image_color WHERE id = :id";
